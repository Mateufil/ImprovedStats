...
To pin a stat you need to go into the info menu by pressing a stat, and then press the <cg>Pin</c> button.

Pinned stats appear on the <cj>first page</c> of the <cl>Stats Menu</c>.
